...
public sealed class GatewaySettings
{
    ...
    public string UpstreamBaseUrl { get; set; } = "https://ailili.chat/v1";
    public bool CompatibilityMode { get; set; }
    public string DirectCodexBaseUrl { get; set; } = "https://ailili.chat/v1";
...
public sealed class CodexSettings
{
    ...
    public string BaseUrl { get; set; } = "https://ailili.chat/v1";
