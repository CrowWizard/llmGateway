...
{
    public async Task<string> InstallEcommerceImageStudioAsync()
    {
        ...
        await CodexContentInstaller.InstallAsync(sourceDirectory, targetDirectory, paths.CodexTemporaryDirectory);

        await InstallAgentsMarketplaceAsync();
        return targetDirectory;
    }

    private async Task InstallAgentsMarketplaceAsync()
    {
