...
public sealed class AppPaths
{
    ...
    public string AililiCredentialsPath => Path.Combine(CodexDirectory, "ailili-account.json");
    ...
    public string NodeRuntimeSourceDirectory => Path.Combine(ApplicationDirectory, "noderuntime");
